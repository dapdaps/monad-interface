...
const menuCls =
  "relative h-full flex flex-1 flex-col items-center hover:drop-shadow-[0px_0px_6px_#FFFFFF80] justify-center cursor-pointer gap-[3px] text-[#A6A6DB] hover:text-[#fff] transition-all duration-300";
const textCls = " text-[11px] font-bold-[200] ";
const hoverCls = "text-[#fff] drop-shadow-[0px_0px_6px_#FFFFFF80]";
const mobileMenuCls =
  "flex items-center justify-center h-[65px] gap-[10px] border-b border-[#38365E]";
      ...
      >
        {!isMobile && (
          <div className="absolute px-[30px] flex items-center justify-between left-1/2 -translate-x-1/2 top-0 bg-[url('/images/header/menu_bg.svg')] bg-contain bg-no-repeat bg-center w-[806px] h-[52px] font-Unbounded">
            <div
              className={clsx(menuCls, pathname === "/" ? hoverCls : "")}
              onClick={() => {
            ...
            <div
              className={clsx(menuCls, pathname === "/faucet" ? hoverCls : "")}
              onClick={() => {
                pathname !== "/faucet" && router.push("/faucet");
              }}
            >
              <FaucetSvg />
            ...
            <div
              className={clsx(
                menuCls,
                pathname.includes("/dapps") || pathname.includes("/dex")
                  ? hoverCls
                  : ""
              )}
              onClick={() => {
                pathname !== "/dapps" && router.push("/dapps");
              }}
            >
              <DappsSvg />
            ...
            <div
              className={clsx(
                menuCls,
                pathname === "/marketplace" ? hoverCls : ""
              )}
              onClick={() => {
                pathname !== "/marketplace" && router.push("/marketplace");
              }}
            >
              <TokenSvg />
            ...
            <div
              className={clsx(
                menuCls,
                pathname.includes("/arcade") ? hoverCls : ""
              )}
              onClick={() => {
                pathname !== "/arcade" && router.push("/arcade");
              }}
            >
              <ArcadeSvg />
        ...
        {isMobile && (
          <motion.div
            ...
            animate={{
              ...
              paddingBottom: isMobileMenuOpen ? "20px" : 0
            }}
          ...
          >
            ...
            >
              <div
                className={clsx(
                  ...
                  pathname === "/" ? mobileTextCls : ""
                )}
              >
                <div className="translate-x-[-10px] translate-y-[6px]">
                  <HomeSvg />
                </div>
            ...
            <div
              className={clsx(
                mobileMenuCls,
                pathname === "/faucet" ? mobileHoverCls : ""
              )}
              onClick={() => {
                router.push("/faucet");
              }}
            ...
            <div
              className={clsx(
                mobileMenuCls,
                pathname === "/marketplace" ? mobileHoverCls : ""
              )}
              onClick={() => {
            ...
            >
              <div
                className={clsx(
                  "flex items-center justify-center gap-[10px]",
                  pathname === "/marketplace" ? mobileTextCls : ""
                )}
              >
                <TokenSvg />
                <div className={clsx(textCls, "")}>Tokens</div>
            ...
            >
              <div
                className={clsx(
                  "flex items-center justify-center gap-[10px]",
                  pathname.includes("/arcade") ? mobileTextCls : ""
                )}
              >
                <ArcadeSvg />
                <div className={clsx(textCls, "")}>Arcade</div>
