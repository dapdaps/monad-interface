      ...
      <Card>
        <div className="w-[520px]">
          <div
            ...
            className="flex items-center gap-[10px] cursor-pointer text-[20px]"
          >
            <svg
              width="9"
              height="16"
              ...
              ?.map((item: Token) => {
                return (
                  <div
                    ...
                    className={
                      "flex items-center justify-between h-[52px] px-[10px] rounded-[10px] cursor-pointer hover:bg-[#0000000F] " +
                      (token === item ? "bg-[#0000000F]" : "")
                    }
                  >
                    <div className="flex items-center gap-2">
                      <img className="w-[26px] h-[26px]" src={item.icon} />
                      <div>
