...
export default memo(function Records() {
  ...
  return (
    <div className="p-[33px_3px_12px_16px] flex flex-col gap-[12px]">
      <div className="flex items-center justify-between">
        <span className="text-white font-Unbounded text-[14px]">Invited ({inviteRecords?.length ?? 0})</span>
        {
          Big(unClaimAmount).gt(0) && (
            <>
              {
                claimLoading ? (
      ...
      <div className="h-[304px] rounded-[6px] border border-[#26274B] bg-[#31305A]">
        <FlexTable
