...
const InvitationViewMobile = () => {
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen z-[101] bg-black bg-[url('/images/mobile/bg-boat-window.png')] bg-no-repeat bg-top bg-[auto_300px] overflow-y-auto pb-[23px]">
