...
const Home = () => {
  ...
  const { run: onBoatFloorStyles, cancel: cancelBoatFloorStyles } =
    useDebounceFn(
      () => {
  ...
  // const dappItems = [
  //   { name: "Lynex", icon: "/images/dapps/icons/Lynex.jpg" },
  //   { name: "iZumi Finance", icon: "/images/dapps/icons/iZumi.jpg" },
  //   { name: "Pancake", icon: "/images/dapps/icons/Pancake.jpg" },
  //   { name: "OpenOcean", icon: "/images/dapps/icons/OpenOcean.jpg" },
  //   { name: "Infinex", icon: "/images/dapps/icons/Infinex.jpg" },
  //   { name: "Orderly", icon: "/images/dapps/icons/Orderly.jpg" },
  //   { name: "D3X", icon: "/images/dapps/icons/d3X.svg" },
  //   { name: "LFJ", icon: "/images/dapps/icons/LFJ.jpg" },
      ...
      >
        <div className="relative w-full h-full min-h-[635px] min-w-[1440px]">
          ...
          <div
            ...
            className={clsx(
              "absolute left-[calc(70/14.4*var(--rem))] bottom-[calc(344/14.4*var(--rem))] w-[357px] h-[430px]",
              windowWidth >= 2560 ? "scale-[1.3] hover:scale-[1.4]" : "",
              windowWidth >= 1920 && windowWidth < 2560
                ? "hover:scale-[1.1]"
                : "",
              ...
              <div className="absolute left-1/2 -translate-x-1/2 mr-[50px] top-[10px]">
                <div className="w-full flex flex-col gap-[2px] items-center justify-center">
                  <div className="w-full flex items-center justify-center gap-2">
                    <img
                      src="/images/monad/icon/bridge-lock.svg"
                      className="w-[43px]"
                      alt=""
                    />
          ...
          <div
            ...
            className={clsx(
              ...
              windowWidth >= 1920 && windowWidth < 2560
                ? "-top-[88px] left-[calc(532/14.4*var(--rem))] hover:scale-[1.1]"
                : "",
              windowWidth >= 2560
          ...
          >
            <div className="absolute left-1/2 -translate-x-[calc(50%+70px)] top-0">
              <div className="w-full flex gap-[4px] items-center justify-center">
                <div className="w-full flex items-center justify-center gap-2">
                  <img
                    src="/images/monad/icon/arcade.svg"
                    alt=""
                    className="shrink-0"
                  />
                </div>
          ...
          <div
            ...
            className={clsx(
              ...
              windowWidth >= 1440 && windowWidth < 1920
                ...
                : "",
              windowWidth >= 1920 && windowWidth < 2560
                ? "top-0 right-[calc(190/14.4*var(--rem))] hover:scale-[1.1]"
                : "",
              windowWidth >= 2560
                ? "top-[80px] right-[calc(190/14.4*var(--rem))] scale-[1.3] hover:scale-[1.4]"
                : ""
            )}
          >
            <Popover
          ...
          >
            <div className="relative w-full h-full z-[35]">
              <div className="absolute left-1/2 -translate-x-1/2 top-[-40px] cursor-pointer">
                <div className="w-full flex flex-col gap-[2px] items-center justify-center">
                  <img
                    src="/images/monad/icon/faucet.svg"
                    alt=""
                    className="w-[74px]"
                  />
                  <motion.img
          ...
          <div
            ...
            className={clsx(
              "z-[35] absolute right-[calc(70/14.4*var(--rem))] bottom-[calc(83/14.4*var(--rem))] w-[519px] h-[451px]",
              windowWidth >= 1440 && windowWidth < 1920
                ? "hover:scale-[1.03] bottom-[calc(63/14.4*var(--rem))]"
                : "",
              windowWidth >= 1920 && windowWidth < 2560
                ? "hover:scale-[1.1]"
                : "",
              windowWidth >= 2560
                ? "scale-[1.3] hover:scale-[1.4] !right-[calc(200/14.4*var(--rem))] bottom-[calc(63/14.4*var(--rem))]"
                : "",
              windowWidth < 1440 && windowWidth >= 1380
                ? "scale-[0.86] hover:scale-[0.92] !right-[calc(150/14.4*var(--rem))] bottom-[calc(90/14.4*var(--rem))]"
                : "",
              windowWidth < 1380
                ? "scale-[0.76] hover:scale-[0.82] !right-[calc(280/14.4*var(--rem))] bottom-[calc(90/14.4*var(--rem))]"
                : "",
              "bg-no-repeat bg-contain",
              "transition-all duration-200 ease-in-out cursor-pointer",
          ...
          >
            <div className="relative w-full h-full">
              <div className="absolute left-1/2 -translate-x-1/2 top-[-50px]">
                <div className="w-full flex flex-col gap-[2px] items-center justify-center">
                  <img
                    src="/images/monad/icon/dApps.svg"
                    className="w-[70px]"
                    alt=""
                  />
                  <motion.img
              ...
              >
                <div
                  className="w-[105px] overflow-hidden mt-1"
                  ref={containerRef}
                >
                  <motion.div
          ...
          >
            <div className="relative w-full h-full">
              <div className="absolute left-1/2 -translate-x-1/2 top-[-50px]">
                <div className="w-full flex flex-col gap-[2px] items-center justify-center">
                  <img
                    src="/images/monad/icon/tokens.svg"
                    className="w-[75px]"
                    alt=""
                  />
                  <motion.img
              ...
              <div className="absolute left-[170px] top-[125px]">
                <img
                  src="/images/monad/background/tokens-moyaki.gif"
                  className="w-[100px]"
                  alt=""
                />
              </div>
