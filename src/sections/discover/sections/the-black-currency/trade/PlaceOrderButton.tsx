...
export default function PlaceOrderButton({
  ...
  const filterId = useMemo(
    () => `filter0_d_${Math.random().toString(36).substr(2, 9)}`,
    []
  );
          ...
          <>
            ...
            >
              <g filter={`url(#${filterId})`}>
                <path
                  d="M18.7734 14.336C19.4401 14.7209 19.4401 15.6831 18.7734 16.068L11.5055 20.2642C10.6195 20.7757 9.62791 19.7842 10.1395 18.8982L11.9848 15.702C12.1634 15.3926 12.1634 15.0114 11.9848 14.702L10.1395 11.5059C9.62791 10.6198 10.6195 9.62828 11.5055 10.1398L18.7734 14.336Z"
                  fill="white"
                />
              </g>
              <defs>
