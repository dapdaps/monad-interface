...

                        {
                            type === "payouts" && (
                                <>
                                    ...
                                    {
                                        item.code !== '666' && item.code !== '777' && item.code !== '888' && item.code !== '999' && item.code !== '101010' && item.code !== '111111' && item.code !== '121212' && item.code !== '131313' && item.code !== '141414' && item.code !== '151515' && (<>
                                            <div className="flex-1 flex items-center gap-2 whitespace-nowrap">
                                                {item.amount} MON
