...
export default function NftT(props: any) {
  const { chogstarrr, monadverse, monadoon, slmnd, lamouch, overnads, deadnads, coronad, monshape, llamao, skrumpeys, moana, spikynads, mop, mondies, nns, baldnads, olwsmonad } = props;
  const nfts = [
    ...
    { key: "olwsmonad", data: olwsmonad, img: "/images/lucky777/nft-olwsmonad-t.png", cls: 'rotate-[0deg] w-[157px] h-[175px]', textCls: '' },
