    ...
    <div className='absolute bottom-[80px] left-[40px] z-[2] w-[127px] h-[175px]'>
      <AnimatePresence mode="wait">
        {nfts.length > 0 && (
          ...
          >
            <img src={nfts[currentIndex].img} alt="" className={clsx('w-[127px] absolute top-0 left-0', nfts[currentIndex].key === 'monadoon' ? 'h-[165px]' : 'h-[175px]')} />
            <div className="absolute right-[20px] bottom-[70px] font-Montserrat text-[14px] font-bold italic text-white rotate-[-5deg] drop-shadow-[2px_2px_0_#000] [text-shadow:0_0_2px_#000,1px_1px_0_#000,-1px_-1px_0_#000,1px_-1px_0_#000,-1px_1px_0_#000]">
