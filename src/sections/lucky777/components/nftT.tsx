...
export default function NftT(props: any) {
  const { chogstarrr, monadverse, monadoon, slmnd, lamouch, overnads, deadnads, coronad, monshape, llamao, skrumpeys, moana, spikynads, mop, mondies, nns, baldnads, owlsmonad } = props;
  const nfts = [
