...
import Header from "@/sections/swap/Header";
...
export default function Swap({
  ...
  const { loading, tradeList, onQuoter, onSwap, selectedRoute, setSelectedRoute } = useTrade({
    ...
    <>
      ...
      <div className="md:max-h-[calc(100dvh-210px)] md:overflow-y-auto">
        ...
        <TokenAmount
          ...
          amount={selectedRoute?.outputCurrencyAmount}
          disabled
          prices={prices}
          account
        ...
        {
          !!(tradeList && inputCurrency && outputCurrency && tradeList.length > 0) && (
            <Routes
              routes={tradeList}
              fromChain={from}
              toToken={outputCurrency}
        ...
        <SubmitBtn
          ...
          amount={inputCurrencyAmount}
          isApproveMax={selectedRoute?.type === "UniversalRouter"}
          spender={selectedRoute?.type === "UniversalRouter" ? "0xC51DA9473283695884AD536FFD180e618Bf6186e" : selectedRoute?.routerAddress}
          errorTips={errorTips}
          token={inputCurrency}
          loading={loading}
          onClick={() => {
            onSwap(selectedRoute);
          }}
          disabled={selectedRoute?.noPair || !selectedRoute?.txn}
          onRefresh={() => {
            runQuoter();
          }}
