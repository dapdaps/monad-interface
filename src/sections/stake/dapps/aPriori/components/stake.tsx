  ...
  return (
    <div className="pt-4">
      ...
      <div className="bg-[#26234B] rounded-xl p-5 mb-4 lg:bg-white/5">
        ...
        <div className="flex justify-between items-center mb-2">
          ...
          <div className="flex flex-col items-end">
            ...
            >
              balance: {balanceFormated(balances["native"])}
            </span>
          </div>
        </div>
      ...
      <div className="bg-[#26234B] rounded-xl p-5 mt-4 lg:bg-white/5">
        <div className="flex justify-between items-center mb-2">
          <span className="text-[14px] text-[#A6A6DB] font-semibold">
            Receive
          </span>
        </div>
        <div className="flex items-center mb-2 justify-between">
          <div className="text-[26px] text-white mr-3">
            {balanceFormated(receive)}
          </div>
          <div className="flex flex-col items-end">
            <div className="flex items-center bg-[#3B3860] rounded-lg px-3 py-1 cursor-pointer">
            ...
            <span className="text-[10px] text-[#B6B3D6] mt-[5px]">
...
export const StakeBtn = ({
  ...
  return (
    <button
      disabled={
        isStakeLoading ||
        Number(amount) >= Number(balances["native"]) ||
        Number(amount) <= 0
      }
      onClick={async () => {
