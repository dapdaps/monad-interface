      ...
      >
        <div className="absolute md:-left-[10px] -left-[20px] md:-top-[10px] -top-[20px] md:w-[390px] w-[494px] md:h-[400px] h-[300px]">
          {isMobile ? (
            ...
            <img src="/images/faucet/verification_bg.svg" />
          )}
        </div>
        <div className="absolute md:p-[40px_14px_0] p-[40px_28px_0]  left-0 top-0 right-0 bottom-0">
              ...
              <div className="w-[120px] bg-white">
                <img
                  src={`${
                    ...
                    "https://testnet-api-monad.dapdap.net"
                  }/api/captcha/image/${captchaId}.png`}
                  alt="captcha"
                />
              </div>
              <span
          ...
          <div className="mt-[64px] flex justify-center">
            <span className="underline cursor-pointer" onClick={handleCheckIn}>
              submit
            </span>
          </div>
        </div>
