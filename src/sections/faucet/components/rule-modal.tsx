...
export default memo(function RuleModal() {
  ...
  return (
    ...
    >
      ...
      <div className="relative p-[61px_48px_0] md:w-[390px] w-[644px] md:h-[400px] h-[300px] md:bg-[url('/images/faucet/mobile/modal_bg.svg')] bg-[url('/images/faucet/rule_bg.svg')] bg-contain bg-no-repeat text-[#A5FFFD] font-DogicaPixel">
