  ...
  return (
    <div
      className={clsx(
        ...
        item.checkin_date ? (item.reward_amount ? "bg-[#BFFF60]" : "bg-[#836EF9] bg-[url('/images/faucet/icon-un-check-in.svg')]") : "bg-[#3E347C] bg-[url('/images/faucet/icon-un-check-in.svg')]",
        className
      )}
    >
      {
