...
export default memo(function HistoryModal() {
  ...
  return (
    <Modal open={showHistory} onClose={onClose}>
      <div className="relative w-full drop-shadow-[0_0_10px_rgba(0,0,0,0.05)] h-[634px]">
        <div className="flex flex-col absolute left-0 -top-[10px] right-0 bottom-0 z-10">
          <div className="w-full">
            <img
              className="w-full"
              src="/images/dapps/mobile/modal_top.svg"
              alt="modal_top"
            />
          </div>
        ...
        <div className="absolute p-[17px_24px] left-0 top-0 bottom-0 right-0 z-20">
          <div className="text-white font-Unbounded text-[16px] font-medium leading-[100%]">
            Check-in History
          </div>
          <FlexTable
            loading={loading}
        ...
        <svg
          onClick={onClose}
          className="absolute right-[17px] top-[13px] z-20"
          xmlns="http://www.w3.org/2000/svg"
          width="14"
          height="12"
          viewBox="0 0 14 12"
        ...
        >
          ...
          <path
            d="M9.16506 10.25C8.20281 11.9167 5.79719 11.9167 4.83494 10.25L1.37083 4.25C0.408585 2.58333 1.61139 0.5 3.5359 0.5L10.4641 0.5C12.3886 0.5 13.5914 2.58333 12.6292 4.25L9.16506 10.25Z"
            stroke="black"
          />
          <defs>
            <filter
              id="filter0_i_33330_3208"
              x="0.531433"
              y="0"
              width="12.9371"
              height="12"
            ...
            >
              ...
              <feBlend
                mode="normal"
                in2="shape"
                result="effect1_innerShadow_33330_3208"
              />
            </filter>
          </defs>
        </svg>
