      ...
      <div className="absolute left-0 right-0 bottom-0 h-[87px] bg-[#23243D] border-t-[18px] border-[#273051]">
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 z-10 w-[470px] h-[136px] bg-[url('/images/dapps/operation_panel.svg')] bg-center bg-contain bg-no-repeat">
          <RectangularButton
            ...
            className={clsx(
              "absolute left-[52px] top-[24px] w-[178px] h-[36px]",
              activeType === "all"
          ...
          <div className="absolute left-[46px] top-[71px] flex gap-[10px]">
            <RectangularButton
              type={1}
              bgColor={
                activeType === "bridge" ? "bg-[#A5FFFD]" : "bg-[#A6A6D2]"
              }
              className={clsx(
                "w-[86px] h-[36px]",
                activeType === "bridge"
            ...
            <RectangularButton
              type={3}
              bgColor={
                activeType === "lending" ? "bg-[#A5FFFD]" : "bg-[#A6A6D2]"
              }
              className={clsx(
                "w-[86px] h-[36px]",
                activeType === "lending"
            ...
            <RectangularButton
              type={2}
              bgColor={
                activeType === "staking" ? "bg-[#A5FFFD]" : "bg-[#A6A6D2]"
              }
              className={clsx(
                "w-[86px] h-[36px]",
                activeType === "staking"
