...
const DappInfo: React.FC<any> = ({
  ...
  return isMobile ? (
    <Modal open={name} onClose={onMouseLeave}>
      <div
        className={clsx("relative w-full drop-shadow-[0_0_10px_rgba(0,0,0,0.05)]", link.startsWith("http") ? "h-[410px]" : "h-[370px]")}
      >
        ...
        <div className="absolute p-[17px_24px] left-0 top-0 bottom-0 right-0 z-20">
          <div className="flex items-center gap-[16px]">
            ...
            <div className="flex flex-col gap-[10px]">
              <div className="text-white font-Unbounded text-[16px] font-medium leading-[100%]">{name}</div>
              <div className="text-white font-Unbounded text-[12px] font-light leading-[100%]">{capitalize(category)}</div>
            </div>
          </div>
          <div className="m-[31px_0_16px] flex items-center justify-between">
            <div className="flex flex-col gap-[4px]">
              ...
              <div className="text-white font-Unbounded text-[14px] font-normal leading-[150%]">{tvl || "-"}</div>
            </div>

            <div className="flex flex-col gap-[4px]">
              <div className="text-white font-Unbounded text-[12px] font-light leading-[150%] opacity-60">Volume 24h</div>
              <div className="text-white font-Unbounded text-[14px] font-normal leading-[150%]">{volume24h || "-"}</div>
            </div>

            <div className="flex flex-col gap-[4px]">
              <div className="text-white font-Unbounded text-[12px] font-light leading-[150%] opacity-60">Liquidity</div>
              <div className="text-white font-Unbounded text-[14px] font-normal leading-[150%]">{liquidity || "-"}</div>
            </div>
          </div>
        ...
        <svg className="absolute right-[17px] top-[13px] z-20" xmlns="http://www.w3.org/2000/svg" width="14" height="12" viewBox="0 0 14 12" fill="none">
