...
export default memo(function RectangularButton({
  ...
  return (
    <div className={clsx("relative flex  border border-black rounded-[6px] transform", disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer ", type === 1 ? "skew-x-[-5deg]" : (type === 2 ? "skew-x-[5deg]" : ""), clicked ? 'bg-[#A5FFFD] drop-shadow-[0_0_10px_rgba(165, 255, 253, 0.60)]' : 'bg-[#A6A6D2] drop-shadow-[0_6px_0_#000]', className)} onClick={onClick}>
