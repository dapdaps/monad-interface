...
export default function HistoryModal({
    ...
    const fetchBidRecords = useCallback(async () => {
        ...
        try {
            const res = await get('/game/chartvoyager/user/orders', {
                page: bidRecordsPage,
                page_size: PAGE_SIZE,
                newQuery: 1
            });
    ...
    const getDepositList = useCallback(async () => {
        ...
        try {
            const res = await get('/game/chartvoyager/user/deposits', {
                page: depositPage,
                page_size: PAGE_SIZE,
                newQuery: 1
            });
    ...
    const getWithdrawList = useCallback(async () => {
        ...
        try {
            const res = await get('/game/chartvoyager/user/withdraws', {
                page: withdrawPage,
                page_size: PAGE_SIZE,
                newQuery: 1
            });
