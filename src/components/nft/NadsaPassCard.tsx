    ...
    return (
        <div className="w-[308px] p-4 relative">
            ...
            <div className="relative pt-[65px] z-10 px-[10px]">
                ...
                {
                    status === 0 && (
                        <button onClick={() => mintNFT()} className="flex w-full items-center justify-center text-[12px] h-[40px] mt-[10px] mb-[10px] bg-[#7663F4] text-[#fff] rounded-[2px] font-Pixelmix">
