...
const slides = [
  {
    img: "/images/nft/home/main-1.png",
  ...
  {
    img: "/images/nft/home/main-2.png",
    title: "WELCOME ONBOARDING NADSA",
  ...
  {
    img: "/images/nft/home/main-3.png",
    title: "WELCOME ONBOARDING NADSA",
...
export default function Aboarding({
  ...
  const { nftMetadata, nftAddress, mintNFT, hasNFT, tokenIds, isLoading } =
    useSoulboundNFT({
      ...
      nftAddress:
        process.env.NEXT_PUBLIC_INDEX_NFT ||
        "0x01E266Be41C053DC537315d6ed4ea9F487f5A037"
    });
    ...
    try {
      ...
      if (node) {
        ...
        const tweetUrl = `https://${
          IS_TEST ? "test." : ""
        }nadsa.space/api/twitter?img=${encodeURIComponent(url)}`;
  ...
  return (
    ...
    >
      <div
        className={clsx(
          "relative top-[10px] ",
          isMobile ? "w-full" : "w-[714px] h-[721px]"
        )}
      >
        <div
          className={clsx(
            "absolute  top-0 w-full h-full",
            isMobile ? "left-[-10%]" : "left-0"
          )}
        >
          <img
            ...
            className={clsx(
              "h-full",
              isMobile ? "w-[120%] max-w-[120%]" : "w-full"
            )}
          />
        </div>
        <svg
          ...
          className={clsx(
            ...
            isMobile ? "top-[10px] right-[10px]" : "top-[70px] right-[30px]"
          )}
          width="14"
          height="12"
          viewBox="0 0 14 12"
        ...
        <div className="w-full h-full relative">
          ...
          {!isLast && (
            <div>
              <div
                className={clsx(
                  "w-full text-center  text-[#E7E2FF] uppercase font-HackerNoonV2 drop-shadow-[0px_0px_10px_#836EF9]",
                  isMobile ? "text-[16px] pt-[60px]" : "text-[24px] pt-[70px]"
                )}
              >
                {title}
              </div>
              ...
              <div className="w-full px-8 mt-[30px]">
                <div
                  className={clsx(
                    "text-[#00FF00] whitespace-pre-wrap font-HackerNoonV2 drop-shadow-[0px_0px_10px_#00FF0080]",
                ...
                <div
                  className={clsx(
                    "text-[#00FF00] mt-[10px] whitespace-pre-wrap font-Pixelmix",
                    isMobile ? "text-[14px] min-h-[240px]" : "text-[14px]"
                  )}
                >
            ...
            <div className={clsx("", isMobile ? "pt-[20px]" : "pt-[100px]")}>
              <div className={clsx(isMobile ? "mx-[5px]" : "mx-[50px]")}>
                ...
                >
                  ...
                  {!isSharing && (
                    <div className="w-full h-full flex relative justify-between gap-[10px] px-[10px]">
                        ...
                        >
                          ...
                          {hasNFT && (
                            ...
                            >
                              ...
                              <div
                                className={clsx(
                                  "absolute font-HackerNoonV2  left-0 w-full text-[#000] flex items-center justify-center",
                                  isMobile
                                    ? "h-[20px] text-[14px] top-[49px]"
                                    : "h-[24px] text-[18px] top-[84px]"
                                )}
                              >
                                NO.{tokenIds[0]}
                              </div>
                      ...
                      <div className="flex-1 flex justify-center ">
                        {!isSharing && (
                          <div
                            className={clsx(
                              isMobile ? "pt-[10px]" : "pt-[40px]"
                            )}
                          >
                            <div
                              className={clsx(
                                "text-[#E7E2FF] text-center font-HackerNoonV2 drop-shadow-[0px_0px_10px_#836EF9]",
                                isMobile ? "text-[16px]" : "text-[18px]"
                              )}
                            >
                              SEQUENCE NUMBER NFT
                            ...
                            {!hasNFT && (
                              <>
                                <div
                                  className={clsx(
                                    "font-Pixelmix  rounded-[4px] flex gap-[10px] justify-center items-end  text-[12px]",
                                    isMobile ? "" : "mt-[10px] py-[10px]"
                                  )}
                                >
                                ...
                                <div
                                  className={clsx(
                                    "text-[#836EF9] text-center font-Pixelmix",
                                    isMobile
                                      ? "text-[12px] mt-[10px]"
                                      : "text-[12px] mt-[20px]"
                                  )}
                                ...
                                >
                                  {!isFollow || buttonText ? (
                                    <button
                                      ...
                                      className={clsx(
                                        "w-full bg-[#00FF00] relative text-black flex px-[15px] items-center justify-between rounded font-Pixelmix text-[12px] shadow-[0px_0px_10px_0px_#03E212]",
                                        isMobile ? "h-[27px]" : "h-[44px]"
                                      )}
                                    >
                                      <div className="flex-1 text-center whitespace-nowrap">
                                        {buttonText || "Follow @0xNADSA"}
                                      </div>
                                      <XWrqapper>
                                        {!buttonText && (
                                          <div
                                    ...
                                    <div
                                      className={clsx(
                                        "w-full relative  text-[#836EF9] flex items-center justify-between font-Pixelmix text-[12px] border border-[#836EF9] rounded-[4px] px-[15px]",
                                        isMobile ? "h-[27px]" : "h-[44px]"
                                      )}
                                    >
                            ...
                            {hasNFT && (
                              <>
                                <div className="flex items-center justify-center flex-col">
                                  <div
                                    className={clsx(
                                      "rounded-full overflow-hidden bg-[#1A1A1A80] border-[1px] border-[#E7E2FF80] flex items-center justify-center drop-shadow-[0px_0px_10px_#E7E2FF80]",
                                      isMobile
                                        ? "w-[57px] h-[57px] mt-[10px]"
                                        : "w-[68px] h-[68px] mt-[20px]"
                                    )}
                                  >
                                    <img
                                      src={
                                  ...
                                  <div
                                    className={clsx(
                                      "text-[#000] relative z-10 w-[124px]  font-HackerNoonV2 text-center mt-[-10px] bg-[url('/images/nft/home/no-bg.png')] bg-cover bg-center",
                                      isMobile
                                        ? "h-[20px] text-[14px]"
                                        : "h-[24px] text-[18px]"
                                    )}
                                ...
                                >
                                  ...
                                  <div
                                    className={clsx(
                                      "text-[#00FF00] font-Pixelmix  text-center",
                                      isMobile
                                        ? "text-[12px]"
                                        : "text-[14px] mt-[10px]"
                                    )}
                                  ...
                                  <div
                                    className={clsx(
                                      "text-[#00FF00] whitespace-nowrap font-Pixelmix text-center",
                                  ...
                                  <div className="flex gap-[10px]">
                                    <button
                                      ...
                                      className={clsx(
                                        "flex-1 mt-[10px] mx-auto bg-[#00FF00] text-black flex items-center justify-center rounded font-Pixelmix text-[12px] shadow-[0px_0px_10px_0px_#03E212]",
                                        isMobile ? "h-[27px]" : "h-[44px]"
                                      )}
                                    >
                                      Copy image
                  ...
                  {isSharing && (
                    <div className="w-[563px] h-[292px] flex relative justify-between overflow-hidden">
                      <div className="absolute top-0 left-0 w-full h-full">
                        <img
                      ...
                      <div className="relative flex-1 flex items-center justify-between">
                        <div
                          className={isMobile ? "relative left-[-20px]" : ""}
                        >
                          <div className="w-[270px] h-[292px] overflow-hidden relative">
                            ...
                            />
                            <div
                              className="absolute font-HackerNoonV2 top-[90px] left-[-22px] w-full h-[24px] text-[#000] text-[18px] flex items-center justify-center"
                ...
                <div className="w-full px-8 mt-[30px]">
                  ...
                  <div
                    className={clsx(
                      "text-[#00FF00] text-[14px] mt-[10px] font-Pixelmix",
...

          {
            <div
              className={clsx(
                "absolute bottom-6 right-0 flex gap-4 font-Pixelmix",
                isMobile ? "left-0 justify-between" : "right-8"
              )}
            >
              <button
                onClick={handlePrev}
