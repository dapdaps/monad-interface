export default {
  ...
  143: {
    ...
    icon: "",
    nativeCurrency: { name: "MON", symbol: "MON", decimals: 18 },
    rpcUrls: ["https://rpc.monad.xyz", "https://rpc-mainnet.monadinfra.com", "https://rpc1.monad.xyz","https://rpc2.monad.xyz","https://rpc3.monad.xyz", "https://rpc4.monad.xyz", "https://monad-mainnet-rpc.spidernode.net", "https://monad-mainnet.api.onfinality.io/public"],
    blockExplorers: "https://monadvision.com"
  }
} as { [key: string]: any };
